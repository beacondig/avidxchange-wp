...
class Advanced_Tabs extends Powerpack_Widget {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'icon_color_active',
			[
				'label'     => __( 'Active Icon Color', 'powerpack' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#000000',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Active Title Color', 'powerpack' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#000000',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Active Background Color', 'powerpack' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Active Border Color', 'powerpack' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#000000',
				'condition' => [
