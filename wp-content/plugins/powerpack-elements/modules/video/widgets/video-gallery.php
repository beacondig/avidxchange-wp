...
class Video_Gallery extends Powerpack_Widget {
    ...
    public function get_title() {
        return __( 'Video Gallery', 'powerpack' );
    }
    ...
    public function get_icon() {
        return 'ppicon-video-gallery power-pack-admin-icon';
    }
	...
	public function carousel_settings() {
        ...
        if ( $settings['layout'] == 'carousel' ) {
            ...
            $slider_options = [
                'slidesToShow'           => ( $settings['slides_per_view'] !== '' ) ? absint( $settings['slides_per_view'] ) : 3,
            ...
            $slider_options['responsive'] = [
                [
                    'breakpoint' => 1024,
                    'settings' => [
                        'slidesToShow'      => ( $settings['slides_per_view_tablet'] !== '' ) ? absint( $settings['slides_per_view_tablet'] ) : 2,
                    ],
                ],
                [
                    'breakpoint' => 768,
                    'settings' => [
                        'slidesToShow'      => ( $settings['slides_per_view_mobile'] !== '' ) ? absint( $settings['slides_per_view_mobile'] ) : 2,
                    ]
                ]
            ];
