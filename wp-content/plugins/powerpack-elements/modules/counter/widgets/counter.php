    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'              => 'layout-1',
                'options'              => [
                    'layout-1'     => __( 'Layout 1', 'powerpack' ),
                    'layout-2'     => __( 'Layout 2', 'powerpack' ),
                    'layout-3'     => __( 'Layout 3', 'powerpack' ),
                    'layout-4'     => __( 'Layout 4', 'powerpack' ),
                    'layout-5'     => __( 'Layout 5', 'powerpack' ),
                    'layout-6'     => __( 'Layout 6', 'powerpack' ),
                    'layout-7'     => __( 'Layout 7', 'powerpack' ),
                    'layout-8'     => __( 'Layout 8', 'powerpack' ),
                ],
                'separator'             => 'before',
            ]
        );
        ...
        $this->add_control(
            'counter_speed',
            [
                'label'                 => __( 'Counting Speed', 'powerpack' ),
