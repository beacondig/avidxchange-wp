...
class Table extends Powerpack_Widget {
    ...
    protected function _register_controls() {
        ...
        $repeater_header->start_controls_tab( 'table_header_tab_content', [ 'label' => __( 'Content', 'power-pack' ) ] );
        ...
        $repeater_header->start_controls_tab( 'table_header_tab_icon', [ 'label' => __( 'Icon', 'power-pack' ) ] );
        ...
        $repeater_header->start_controls_tab( 'table_header_tab_advanced', [ 'label' => __( 'Advanced', 'power-pack' ) ] );
        ...
        $repeater_footer_rows->start_controls_tab( 'table_footer_tab_content', [ 'label' => __( 'Content', 'power-pack' ) ] );
        ...
        $repeater_footer_rows->start_controls_tab( 'table_footer_tab_icon', [ 'label' => __( 'Icon', 'power-pack' ) ] );
        ...
        $repeater_footer_rows->start_controls_tab( 'table_footer_tab_advanced', [ 'label' => __( 'Advanced', 'power-pack' ) ] );
                ...
                <?php
                    ...
                    foreach ( $settings['table_headers'] as $index => $item ) :
                        ...
                        if ( $item['cell_icon_type'] == 'image' && $item['cell_icon_image']['url'] != '' ) {
                            $this->add_render_attribute( 'header_col_img-' . $i, 'src', $item['cell_icon_image']['url'] );
                        ...
                        if ( $item['cell_icon_type'] != 'none' ) {
                            ...
                            elseif ( $item['cell_icon_type'] == 'image' && $item['cell_icon_image']['url'] != '' ) {
                                $pp_output .= '<img ' . $this->get_render_attribute_string( 'header_col_img-' . $i ) . '>';
                            }
                            $pp_output .= '</span>';
                        }
                ...
                if ( !empty( $settings['table_footer_content'] ) ) {
                    foreach ( $settings['table_footer_content'] as $index => $item ) {
                        if ( $item['table_footer_element'] == 'cell' ) {
                            ...
                            if ( $item['cell_icon_type'] == 'image' && $item['cell_icon_image']['url'] != '' ) {
                                $this->add_render_attribute( 'footer_col_img-' . $i, 'src', $item['cell_icon_image']['url'] );
                            ...
                            if ( $item['cell_text'] != '' || $item['cell_icon_type'] != 'none' ) {
                                ...
                                if ( $item['cell_icon_type'] != 'none' ) {
                                    ...
                                    elseif ( $item['cell_icon_type'] == 'image' && $item['cell_icon_image']['url'] != '' ) {
                                        $pp_output .= '<img ' . $this->get_render_attribute_string( 'footer_col_img-' . $i ) . '>';
                                    }
                                    $pp_output .= '</span>';
                                }
            ...
            <?php
                ...
                foreach ( $settings['table_body_content'] as $index => $item ) {
                    if ( $item['table_body_element'] == 'cell' ) {
                        ...
                        if ( $item['cell_icon_type'] == 'image' && $item['cell_icon_image']['url'] != '' ) {
                            $this->add_render_attribute( 'col_img-' . $i, 'src', $item['cell_icon_image']['url'] );
                        ...
                        if ( $item['cell_text'] != '' || $item['cell_icon_type'] != 'none' ) {
                            ...
                            if ( $item['cell_icon_type'] != 'none' ) {
                                ...
                                elseif ( $item['cell_icon_type'] == 'image' && $item['cell_icon_image']['url'] != '' ) {
                                    $pp_output .= '<img ' . $this->get_render_attribute_string( 'col_img-' . $i ) . '>';
                                }
                                $pp_output .= '</span>';
                            }
