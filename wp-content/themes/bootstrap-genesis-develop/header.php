...
<body <?php body_class(); ?>>
		<?php get_template_part('partials/content', 'modal-demo'); ?>
		<?php
			$specs1 = array(
				'menu'=> 'top bar menu',
				'echo'=> true,
			...
			$specs2 = array(
				'menu'=> 'Main Menu (2019 brand launch)',
				'container'=>'nav',
				'echo'=> true,
				'fallback_cb'=> 'false',
				'depth'=> 0
			...
			$specs3 = array(
				'menu'=> 'Mobile Menu (2019 brand launch)',
				'container'=>'',
				'echo'=> true,
				'fallback_cb'=> 'false',
				'depth'=> 0
			...
			<header class="site-header-new <?php echo get_field('header_style');?>">
				<div class="container">
					...
					<div class="mobile-nav">
						<a class="demo-button" href="/demo">Request a Demo</a>
