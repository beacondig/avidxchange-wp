...
function bsg_navbar_brand_markup() {
    $output = '<a class="navbar-brand" id="logo" title="' .
        ...
        '" href="' .
            esc_url( home_url( '/' ) ) .
    '">';
        $output .= '<img src="/wp-content/uploads/avidxchange-logo.svg" width="192" height="31" style="height:31px; overflow:hidden;" /><img src="/wp-content/uploads/avidxchange-logo-white.svg" width="192" height="31" style="height:31px; overflow:hidden;" class="waltlogo" />';
    $output .= '</a>';
